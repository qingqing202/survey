				...
				<tr>
					...
					<td width="7%" align="right" nowrap class="operation">
						<span class="hui">管理导航</span><span class="red"> - </span><a
							href="adminEditTunnel.do?action=edit" class="blue">添加</a>
				...
				<table width="100%" align="center" cellspacing="1"
                    ...
                    <tr onmouseover="over()" onclick="change()" onmouseout="out()"	class="td_bg">
						...
						<td align="center" nowrap="nowrap">
							<a href='adminEditTunnel.do?action=edit&chnId=<s:property value="id"/>'>改</a> |
							<a href='adminEditTunnel.do?action=del' onclick="javascript:return getConfirm('删除后将不能恢复！真的要删除吗？');"
								href=''>删</a>
						</td>
					</tr>
					</s:iterator>
