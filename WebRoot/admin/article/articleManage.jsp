...
<html>
  ...
  <body>
    ...
    <div >
    	<form action="/admin369/article/manageArticle.htm?action=save" method="post">
    		<input type="hidden" value="${article.id}" name="article.id">
	    	<table width="75%" cellpadding="5" cellspacing="5"> 
	    		<tr>
	    			<td align="center" width="8%">文章名</td> 
	    		...
	    		<tr>
	    			...
	    			<td> <s:select list="types" name="type"/> </td>
	    		</tr>
	    		<tr>
	    ...
	    <form action="/admin369/article/manageArticle.htm" method="post">
	    ...
	    <table width="80%" cellspacing="3">
		    ...
		    <s:iterator id="rs" value="page.result">
	  			<tr>
	  				...
	  				<td align="center"><a href="/admin369/article/manageArticle.htm?action=delete&id=<s:property value="id" />">删除记录</a></td>
	  				<td align="center"><a href="/admin369/article/manageArticle.htm?action=detail&id=<s:property value="id" />">修改记录</a></td>
