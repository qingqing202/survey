...
<div id="edit">
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="red_xx table_all">
    <tr>
      ...
      <td width="7%" align="right"  nowrap class="operation"><span class="hui">管理导航</span><span class="red"> - </span> <a href="manageRole.do?action=addRole" class="blue">添加</a></td>
    </tr>
  </table>
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="table_all">
    <tr>
 ...
 <s:iterator id="rolelist" value="roleList" status="st">
      ...
      <td align="center">
       <a href='manageRole.do?action=addRole&roleId=${rolelist.id}'>改</a> | 
       <a onclick="javascript:return getConfirm('该角色中的管理员将一并被删除且删除后将不能恢复！真的要删除吗？');" href='manageRole.do?action=delRole&roleId=${rolelist.id}'>删</a> 
       <a href='manageRole.do?action=permlist&roleId=${rolelist.id}&chnId=${chnId}'>权</a></td>
	  </tr>
</s:iterator>
  </table>
  </form>
