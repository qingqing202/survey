...
<script>
	...
	function delete_(id) {
		var url = "manageRemoterTag.do?action=delete&tagId=" + id;
		if(remoterId != "") {
	...
	function edit_(id) {
	  var url = "manageRemoterTag.do?action=edit&tagId=" + id;
	  if(remoterId != "") {
        url += "&remoterId=" + remoterId;
      }
      if(pageNo != "") {
	...
	function add_() {
	  ...
	  var url = "manageRemoterTag.do?action=add";
      url += "&remoterId=" + remoterId;
...
<div id="edit">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="red_xx table_all">
    <tr>
     <td width="93%">
       <span class="title red">遥控器Tag管理-${remoter.id}
  ...
  <s:form id="form1" action="manageRemoterSetting" method="post">
    ...
    <table width="90%" align="center" cellspacing="1" class="table table_all">
      ...
      <tr onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
        ...
        <td height="25" ><div align="center">${rs.tagValue}</div></td>
        <td height="25" >
          <div align="center">
