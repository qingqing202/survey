...
<script>
    ...
    $("document").ready(function() {
		...
		if (tvProgramId != "") $("#tvProgramId").val(tvProgramId);
	});
...
<div id="edit">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="red_xx table_all">
    <tr>
     <td width="93%"><span class="title red">节目添加/编辑</span></td>
  ...
  <s:form id="form1" action="manageTvProgram" method="post">
    ...
    <s:hidden name="tvProgramId" id="tvProgramId"/>
    <table width="90%" align="center" cellspacing="1" class="table table_all">
      <tr class="td_bg">
        <th colspan="2" class="redbold">节目添加/编辑
      ...
      <tr onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
        ...
        <td width="80%" >
	      <input name="channel" type="text" id="brandTyoe" value="${channel}" size="20" maxlength="16" class="input"
	             onClick="this.className='focus'" onmouseover="this.className='hover'" onmouseout="this.className='input'"/>
        </td>
      </tr>
      <tr onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
        <td width="20%" align="center">节目名称：</td>
        <td width="80%" >
