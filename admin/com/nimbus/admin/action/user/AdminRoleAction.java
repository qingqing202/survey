...
import com.nimbus.service.admin.AdminChannelService;
...
public class AdminRoleAction extends AdminBaseAction {
  ...
  public String addRole() {
    ...
    for (AdminChannel chn : depth) {
      list.add(chn);
      List<AdminChannel> parent = channelService.getAdminChannelDepthAsc(chn
          .getId());
      if (parent != null) {
  ...
  public String saveRole() {
    ...
    if (adrole != null) {
      ...
      for (int i = 0; i < arryid.length; i++) {
        ...
        function.setChannel(channelService.findById(Long.parseLong(arryid[i])));
      ...
      String chidlist = str.substring(str.indexOf("[") + 1,
          str.lastIndexOf("]"));
