...
<div id="edit">
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="red_xx table_all">
    <tr>
      ...
      <td align="right"  nowrap="nowrap"><span class="operation"><span class="hui">管理导航</span><span class="red"> - </span> <a href="manageUser.do?act=getAdmlist" class="blue">返回</a></span></td>
    </tr>
  </table>
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
  ...
  <form id="form" name="form" method="post" action="adminLogin.do?action=savepass" onsubmit="return formcheck();">
  ...
  <table width="90%" align="center" cellspacing="1" class="table table_all" id="table1">
    ...
    <tr onMouseOver="over()" onClick="change()" onMouseOut="out()" class="td_bg">
      ...
      <td><input id="password" name="password" size="20" maxlength="16" value="" onkeyup="pwStrength(this.value)" onblur="pwStrength(this.value)" type="password" class="input" onClick="this.className='focus'"  />
