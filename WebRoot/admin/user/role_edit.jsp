...
<div id="edit">
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="red_xx table_all">
    <tr>
      ...
      <td width="7%" align="right"  nowrap class="operation"><span class="hui">管理导航</span><span class="red"> - </span> <a href="manageUser.do?act=getRolelist" class="blue">返回</a></td>
    </tr>
  </table>
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
  ...
  <form id="form" name="form" method="post" action="manageRole.do?action=saveRole" >
