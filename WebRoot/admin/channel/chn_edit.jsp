...
<div id="edit">
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="red_xx table_all">
    <tr>
      ...
      <td align="right"  nowrap="nowrap"><span class="hui operation">管理导航</span><span class="red"> - </span> <a href="manageChannel.do">返回</a></td>
    </tr>
  </table>
  ...
  <form id="form" name="form" method="post" action="adminEditTunnel.do?action=sav" onsubmit="return fromcheck();">
